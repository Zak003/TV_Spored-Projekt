<?php
	...
	<div id ="vs">
		...
		<?php
			//zapis SQL stavka 
			$sql="SELECT tp.id AS id, tp.ime AS ime_programa, o.cas_predvajanja AS cas_predvajanja, o.datum_predvajanja AS datum_predvajanja, o.ime AS oddaja_ime, o.id AS oddaja_id  
			FROM tv_programi tp INNER JOIN oddaje o ON tp.oddaja_id=o.id
            WHERE (DAY(CURRENT_TIMESTAMP)+2) = (DAY(datum_predvajanja))
